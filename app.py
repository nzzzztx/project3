...
app = Flask(__name__)
MONGODB_CONNECTION_STRING = 'mongodb+srv://test:sparta@cluster0.f6od9yz.mongodb.net/?retryWrites=true&w=majority'
...
def api_valid():
    ...
    try :
        ...
        print(payload)
        user_info = db.user.find_one({'id': payload.get('id')}, {'id': 0})
        return jsonify({
            'result': 'success',
